...
public class EndOfMessageDelimitedSampleProtocol : EndOfMessageDelimitedProtocol<EndOfMessageDelimitedSampleProtocolMessage>
{
    ...
    public override TransferFormat Format => TransferFormat.Text;

    protected override EndOfMessageDelimitedSampleProtocolMessage ParseMessage(ReadOnlySequence<byte> span)
    {
