    ...
    IConnectionLifetimeFeature
{
    ...
    internal WebSocketConnectionContext(string id, ILogger logger, IDuplexPipe transport, IDuplexPipe application,
        WebSocketConnectionDispatcherOptions options)
    {
        ...
        ActiveFormat = options.WebSockets.TransferFormat == Protocol.TransferFormat.Binary
